                    ...
                    child: NavigationRail(
                      ...
                      destinations: [
                        buildRotatedTextRailDestination(
                            'Mama\'s Kitchen', padding),
                        buildRotatedTextRailDestination("Mamokacha", padding),
                        buildRotatedTextRailDestination("Mitmita", padding),
                        buildRotatedTextRailDestination("Tomoca", padding),
                        buildRotatedTextRailDestination("Goat CAfe", padding),
                        buildRotatedTextRailDestination("Genesis", padding),
                        buildRotatedTextRailDestination("Chanoly", padding),
          ...
          child: productsBrand.isEmpty
              ? Column(
                  ...
                  children: [
                    ...
                    Text(
                      'No food related to this restaurant',
